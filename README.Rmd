...
You can install the released version of hueniverrrsity from [CRAN](https://CRAN.R-project.org) with:
...
knitr::include_graphics("imgs/alberta_1.png")
```

`beta`
``` {r out.width = "33%", echo = FALSE}
knitr::include_graphics("imgs/alberta_2.png")
```

`gamma`
``` {r out.width = "33%", echo = FALSE}
knitr::include_graphics("imgs/alberta_3.png")
```

`delta`
``` {r out.width = "33%", echo = FALSE}
knitr::include_graphics("imgs/alberta_4.png")
```
...
``` {r theme_alberta(), fig.width = 7, fig.height = 4}
...
``` {r theme_mcgill(), fig.width = 7, fig.height = 4}
ggplot(data = mtcars, aes(x = hp, y = mpg, colour = as.factor(cyl))) +
  geom_point(size = 2.5) +
  theme_mcgill('colour')
```
...
knitr::include_graphics("imgs/toronto_vibrant.png")
```

`cool`
``` {r out.width = "25%", echo = FALSE}
knitr::include_graphics("imgs/toronto_cool.png")
```

`awards`
``` {r out.width = "25%", echo = FALSE}
knitr::include_graphics("imgs/toronto_awards.png")
```
...
``` {r theme_toronto(), fig.width = 7, fig.height = 4}
...
``` {r theme_ubc(), fig.width = 7, fig.height = 4}
